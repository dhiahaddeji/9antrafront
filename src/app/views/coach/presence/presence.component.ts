...
export class PresenceComponent implements OnInit {
  ...
  //  const url = `https://9antraback-production-84f1.up.railway.app/api/sessions/${this.sessions}/groups/${groupId}/users/${userId}/markPresence`;
  ...
  // }
  markUserPresence( groupId: number, userId: number, isPresent: boolean): void {
    const url = `https://9antraback-production-84f1.up.railway.app/api/sessions/${this.sessions}/groups/${groupId}/users/${userId}/presence`;
